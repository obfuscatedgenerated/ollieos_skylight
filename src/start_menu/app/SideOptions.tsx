        ...
        <div className="flex flex-col justify-end gap-2 relative">
            ...
            {power_options_visible && (
                <div className="absolute bottom-10 left-0 bg-background-2 text-foreground rounded shadow-lg flex flex-col gap-1 p-2 w-40">
                    <button className="flex items-center justify-start gap-2 cursor-pointer px-2 py-1 rounded transition-colors hover:bg-accent" onClick={() => exec_and_kill("sl_shutdown", ["-t", "1000"], true)}>
                        <Power className="w-4 h-4" />
                        Shut down
                    </button>
                    <button className="flex items-center justify-start gap-2 cursor-pointer px-2 py-1 rounded transition-colors hover:bg-accent" onClick={() => exec_and_kill("sl_shutdown", ["-r", "-t", "1000"], true)}>
